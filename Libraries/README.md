**************************************************
THESE LIBRARIES ARE NECESSARY FOR ALL CODE TO RUN
**************************************************


This folder contains all libraries that are necessary to run code on the device.

These libraries are for the following devices
-WalterESP32
-MPU6050 IMU
